...
class PixhawkAP : public SwarmAutopilot
{
	...
	enum MsnState { SEND_COUNT, AWAIT_REQ, SEND_ITEM, AWAIT_ACK };
...
private:
	...
	int mavRcvd[256];
	bool hilModeSet = false;
	bool talkingMavlink = false;
	bool waypointTooFar = true;
	bool readyForMission = false;
